...
public class EnemyFSM : MonoBehaviour
{
    ...
    {
        // 피격 모션 시간만큼 기다린다.
        anim.SetFloat("EMove", transform.forward.magnitude);
    ...
    IEnumerator DieProcess()
    {
        ...
        transform.eulerAngles = new Vector3(transform.eulerAngles.x+40, transform.eulerAngles.y-90, transform.eulerAngles.z-91);
